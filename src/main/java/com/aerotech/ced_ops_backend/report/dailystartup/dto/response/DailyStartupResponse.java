...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Response payload for a Daily Startup report")
public class DailyStartupResponse {

    @Schema(description = "Unique identifier of the report", example = "1", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private Long id;

    @Schema(description = "Auto-generated report number", example = "DS-2025-0001", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String reportNumber;

    @Schema(description = "Date of the startup report", example = "2025-01-15", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(description = "List of startup check entries", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private List<DailyStartupEntryResponse> entries;
