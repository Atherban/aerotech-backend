...
@Entity
@Table(name = "daily_startup_entries", indexes = {
    @Index(name = "idx_ds_entries_report_id", columnList = "report_id"),
    @Index(name = "idx_ds_entries_parameter_id", columnList = "parameter_id")
})
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DailyStartupEntry extends BaseEntity {

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "report_id", nullable = false)
    private DailyStartupReport report;
