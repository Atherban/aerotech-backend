...
@Entity
@Table(name = "pre_delivery_inspection_entries", indexes = {
    @Index(name = "idx_pdi_entries_report_id", columnList = "report_id"),
    @Index(name = "idx_pdi_entries_parameter_id", columnList = "parameter_id")
})
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class PreDeliveryInspectionEntry extends BaseEntity {

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "report_id", nullable = false)
    private PreDeliveryInspectionReport report;
