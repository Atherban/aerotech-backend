...
@Entity
@Table(name = "chemical_consumption_entries", indexes = {
    @Index(name = "idx_chem_entries_report_id", columnList = "report_id"),
    @Index(name = "idx_chem_entries_parameter_id", columnList = "parameter_id")
})
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class ChemicalConsumptionEntry extends BaseEntity {

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "report_id", nullable = false)
    private ChemicalConsumptionReport report;
