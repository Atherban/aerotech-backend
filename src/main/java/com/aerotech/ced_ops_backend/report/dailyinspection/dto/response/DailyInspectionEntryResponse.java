...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "An individual entry within a Daily Inspection response")
public class DailyInspectionEntryResponse {
    ...
    @Schema(description = "Name of the inspection parameter", example = "Temperature", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
