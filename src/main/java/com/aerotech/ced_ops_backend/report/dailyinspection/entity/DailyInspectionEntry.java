...
@Entity
@Table(name = "daily_inspection_entries", indexes = {
    @Index(name = "idx_daily_insp_entries_report_id", columnList = "report_id"),
    @Index(name = "idx_daily_insp_entries_parameter_id", columnList = "parameter_id")
})
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DailyInspectionEntry extends BaseEntity {

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "report_id", nullable = false)
    private DailyInspectionReport report;
