...
public class GlobalSearchRequest {
    ...
    @Schema(description = "Line ID", example = "1")
    private Long lineId;
    ...
    @Schema(description = "Start date (ISO format: yyyy-MM-dd)", example = "2025-01-01")
    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
    private LocalDate dateFrom;

    @Parameter(description = "End date (ISO format: yyyy-MM-dd)")
    @Schema(description = "End date (ISO format: yyyy-MM-dd)", example = "2025-12-31")
    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
    private LocalDate dateTo;

    @Size(max = 1000, message = "Remarks must not exceed 1000 characters")
    @Parameter(description = "Partial match on remarks")
    @Schema(description = "Partial match on remarks", example = "urgent")
    private String remarks;

    @Parameter(description = "Filter by approval status: true=approved, false=non-approved")
    @Schema(description = "Filter by approval status", example = "true")
    ...
    @Schema(description = "Sort field", example = "reportDate")
